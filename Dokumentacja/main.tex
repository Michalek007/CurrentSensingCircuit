...
\title{
    ...
    Dokumentacja projektu\\\vspace{0.5cm}
...
\author{Piotr Kowol, Piotr Mosurek, Michał Nizioł}
...
\begin{document}
    ...
    \vfill
    \begin{flushright}
        Piotr Kowol, Piotr Mosurek, Michał Nizioł
    \end{flushright}
\end{document}

% szum w pasmie 200 k - 0.74 mV/sqrt(Hz), pasmo ogranicza INA333 !
% dodanie wtornika na wyjsciu poprawia ch-ke f - zmniejsz podbicie z ok 10 dB do 3 dB :)
% wzmocnienie generatora szumu 41 dB, pasmo (75 - 2.38 M) Hz
% lpf 318 kHz
% pomiar Vcm - kompensacja uplywu pradu (pomiar + obrobka w sofcie)