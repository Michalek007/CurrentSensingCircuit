\section{Schematy ideowe układu}
    ...
    \begin{figure}[!ht]
        \centering
        \scalebox{1}{\input{schematics/Vref_noise_gen.tex}}
        \caption{Schemat ideowy źródła napięcia referencyjnego z układem generacji szumu.}
        \label{sch:Vref_gen}
    \end{figure}
    \begin{figure}[!ht]
        \centering
        \scalebox{1}{\input{schematics/Vcm_measure.tex}}
    ...
    \begin{figure}[!ht]
        \centering
        \scalebox{1}{\input{schematics/LPF.tex}}
    ...
    % \begin{figure}[!ht]
    %     \centering
    %     \scalebox{1}{\input{schematics/Sumator.tex}}
    %     \caption{Układ sumacyjny dla dodania sygnału pomiarowego i szumu.}
    %     \label{sch:sumator}
    % \end{figure}
    \begin{figure}[!ht]
        \centering
        \scalebox{1}{\input{schematics/PSU.tex}}
